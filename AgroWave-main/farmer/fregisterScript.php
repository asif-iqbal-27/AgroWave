...
function create_user($name, $password, $email, $mobile, $gender, $dob, $district, $city)
{
	global $conn;

	$query = "INSERT INTO farmerlogin (farmer_name, password, email, phone_no, F_gender, F_birthday, F_District, F_Location) 
    VALUES ('$name', '$password', '$email', '$mobile', '$gender', '$dob',  '$district', '$city')";
...
if (isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirmpassword'])) {
	...
	if (is_valid_email($email) == true && is_valid_passwords($password, $cpassword) == true) {
		if (create_user($name, $password, $email, $mobile, $gender, $dob, $district, $city)) {
